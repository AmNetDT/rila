                             ...
                             <form class="row" method="POST" autocomplete="off">
                                 <div class="col-sm-6">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <select class="form-control" name="payment_type" id="payment_type">
                                             <option value="<?php echo $ptypes->payment_type; ?>"><?php echo $ptypes->payment_type; ?></option>
                                             <?php
                                 ...
                                 <div class="col-sm-6">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <textarea id="remark" class="remark" class="form-control"><?php echo $ptypes->paid; ?></textarea>
                                     </div>
                                 </div>
                                 <?php
