...
<style>
  .menutree{
  margin-left: -22px; width: 190px; padding-left:5px;
  border: dotted 1px #fff; margin-top: 5px; text-decoration:none;
  }
  .menutree:hover{
  position:relative; border: dotted 1px #fff; text-decoration:none;
  }
  .sub-menutree{
  margin-left: 10px; width: 190px; padding:2px 5px;
  margin-top: 5px; border: dotted 1px #fff; text-decoration:none;
  }
  .foot {
   position: fixed;
   left: 0;
